  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-pink-200 via-rose-200 to-red-200 p-4">
      <motion.div
        ...
        className="flex gap-4 justify-center text-3xl mb-6 absolute top-10"
      >
        <span>💕</span>
        <span>🧸</span>
        <span>💖</span>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl">
        {flowers.map((flower, idx) => (
          ...
          >
            {/* Decorative emoji */}
            <div className="text-4xl mb-2">{decorEmojis[idx]}</div>
            ...
            <div className="text-4xl mt-2">{decorEmojis[idx]}</div>
          </motion.div>
        ))}
      </div>
      ...
      <motion.div
        ...
        className="flex gap-4 justify-center text-3xl mt-8 absolute bottom-10"
      >
        <span>💕</span>
        <span>🧸</span>
        <span>💖</span>
