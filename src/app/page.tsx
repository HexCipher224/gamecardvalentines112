...
export default function Home() {
  const [page, setPage] = useState<"game" | "giftbox" | "proposal" | "envelope" | "letter" | "forever" | "flowers">("game");
    ...
    <OrientationGuard>
      <main className="flex items-center justify-center min-h-screen bg-black overflow-hidden relative">
        {page === "game" && (
          ...
          >
            <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-pink-500 mb-6 drop-shadow-lg">💖 For Triza 💖</h1>
